...
class SettingModeFragment : BottomSheetDialogFragment() {
    lateinit var binding: FragmentSettingModeBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSettingModeBinding.inflate(inflater, container, false)
